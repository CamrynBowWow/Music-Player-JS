// TODO : All typed 'let' variables should be changed to 'const' if they are not being re-assigned
// TODO : Split this file into more specific javascript files. It is will become over whelming in future
...
window.onload = function () {
  ...
  // TODO : Why is the page halted for a full second?
...
async function makeBlobPutIntoDb(entry) {
  ...
  // TODO : ByteSize is not correct here as it is returning an array buffer?
  let byteSize = await blobToArrayBuffer(fileData); // Turns into blob

  // TODO : binary code be more appropriately named
  let binary = new Uint8Array(byteSize); // Gets the bytes to use for the audio
  // TODO : Rogue console log
  console.log("work");
...
addDirectory.addEventListener("click", async () => {
  // LOOK MATTHEW
  // TODO : peen could have a more descriptive name
...
const artistNameHeader = document.querySelector(
  ".container-play-music-area h3"
);
...
// TODO : Could be more appropriately named
...
sourceTag.ontimeupdate = function () {
  progressTimeUpdate();
};
